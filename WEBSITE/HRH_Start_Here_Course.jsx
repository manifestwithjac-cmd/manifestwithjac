...
const CONFIG = {
  ...
  CATEGORY_4_EMOJI: "🏆",
  CATEGORY_4_NAME: "Let's Celebrate",
  CATEGORY_4_DESC: "Post your wins and your claims, comment 444",
...
const lessons = [
  ...
  // ============== DAY 1 ==============
  {
    ...
    overview: {
      ...
      showAboutFounder: true,
      showCommonEnemy: true,
    ...
    concepts: [
      ...
      { type: "accordion", headline: "Manifestation is only three things", icon: "🌙",
        ...
        body: "That is the whole thing. Everyone overcomplicates it. We do not." },
      { type: "accordion", headline: "Step three is where everyone gets stuck", icon: "🌊",
        body: "Living as if sounds simple until you try it and your body panics, because what you are reaching for is unfamiliar. That panic is not a flaw, it is a nervous system that has not been shown the new normal yet. The entire point of this space is to make the life you want feel safe and ordinary in your body, so you stop sabotaging it the second it gets close." },
      { type: "accordion", headline: "You are remembering her, not becoming her", icon: "👑",
        body: "The version of you who already has the money, the love, the body, the ease, she is not in some far-off future. She is who you actually are underneath all the conditioning. We are not building someone new. We are clearing everything between you and her." },
      { type: "pullquote",
        text: "The woman it all flows to is already in you. Your only job in here is to stop arguing with her." },
    ],
    actions: [
      ...
      "Post your intro in Let's Celebrate 🏆 and comment 444 to lock in what you are calling in. Start earning your 🔥 streak by commenting on 2 or 3 other posts right now.",
    ],
    promptIntro: "Copy this and paste it as your first post in Let's Celebrate 🏆. Fill in the arrows, that is it.",
  ...
  // ============== DAY 2 ==============
  {
    ...
    overview: {
      desc: "This is the teaching everything else stands on. Affirmations on their own barely move the needle because they only touch your conscious mind, and your conscious mind is running maybe 5% of the show. The other 95% is your body and your subconscious. Once you get this, every room in here stops feeling like one more thing to do and starts feeling like the only way that actually works.",
      hero: "Your body is not the obstacle to your manifestation. Your body is the entire mechanism. Everything happens through it.",
    },
    concepts: [
      { type: "callout", style: "white", headline: "It was never your fault, and you are not behind.",
        body: "The belief that money is hard, that love is scarce, that you have to struggle for everything, that was installed in you before you could even talk. Family, culture, the news, all of it. You did not choose it and you are not broken for carrying it. We are not fixing you. We are clearing the programming so the real you can run the show." },
      { type: "pullquote",
        text: "Surface level manifestation touches what you think. We work the layer underneath it, the body that decides what you are allowed to have." },
      { type: "accordion", headline: "Step 1: You are creating it, not receiving it", icon: "⚡",
        body: "Life is not happening to you, it is happening through you. The moment you really feel that you are the one bending your reality, you stop waiting for permission and start giving instructions. This is the awareness everything else needs. If you are in here, some part of you already knows it is true." },
      { type: "accordion", headline: "Step 2: Clarity is the instruction", icon: "🎯",
        body: "You cannot call in a blur. The clearer you are on the number, the person, the feeling, the more precise the directions you are handing the universe for the timeline you want. Vague desires get vague results. Specific desires get specific ones. Decide what you actually want." },
      { type: "accordion", headline: "Step 3: Live as if, until your body believes it", icon: "🌊",
        body: "You do not become her after the money or the love arrives. You feel like her first, and reality rearranges to match. The catch is your nervous system has to feel that new normal as safe, or it sabotages the second things get close. So we make it safe. We normalize the having. What you normalize will materialize, that is the whole engine." },
      { type: "accordion", headline: "EFT is how we clear the block fast", icon: "💧",
        body: "Tapping works the meridian points to rewire the beliefs living dormant in your body, the ones actually running the show. When the bill panic hits, the comparison spiral hits, the doubt creeps in, you tap. It is the fastest way to take a desire that feels unsafe and make it feel like an of-course. Your vault is full of these, one for every lane." },
      { type: "pullquote",
        text: "You do not have to be high vibe 24/7. You are human. The question is just how fast you come back to everything is always working out for me." },
    ],
    actions: [
      "Open the Foundations classroom and watch the Intro to EFT Tapping lesson.",
      "Do one tapping round tonight. New to tapping? The 2-minute points guide is at manifestwithjac.netlify.app/eft-tapping-points-guide",
      "Save your three steps somewhere you will see them daily: I am creating it. I am clear on it. I live as if it is already mine.",
      "Pick one thing you have been forcing or stressing over, and for the next 7 days practice the line everything is always working out for me when it comes up.",
      "Optional, follow along where I share more: Instagram @manifestwithjac and TikTok @manifestwithjac.",
    ],
    prompt: "The desire I am working on is [YOUR DESIRE] and right now my body still feels [SCARED / UNSURE / EXCITED / NUMB] about actually having it.\n\nHelp me write a short, real post for the Let's Celebrate 🏆 feed. It should name one old belief about this that I am ready to release, what I am choosing to believe instead, and end with a question that invites other women to share what they are releasing too. My voice: warm, real, a little delusional in the best way, no clinical jargon, under 150 words. Make it sound like me thinking out loud, not a lesson.",
  },
  ...
  // ============== DAY 3 ==============
  {
    ...
    concepts: [
      { type: "path-picker" },
      { type: "accordion", headline: "Get specific or you stay vague", icon: "🎯",
        body: "If you say I just want more money, the universe can hand you a dime on the sidewalk and technically deliver. Clarity is the instruction. The clearer you are about the number, the person, the feeling, the life, the better the directions you are giving for the timeline you want to live in. Vague in, vague out." },
      { type: "accordion", headline: "Pick the one that makes your stomach flip", icon: "🌟",
        body: "Read the five lanes and notice which one your body leans toward, or which one makes you a little nervous. That nervous one is usually the truest one. You are allowed to want all of it, that is the whole point of being delusional in the best way, but you give your nervous system one clear focus to settle into first. The rest does not disappear, it waits its turn." },
  ...
  // ============== DAY 4 ==============
  {
    ...
    actions: [
      ...
      "Post in Let's Celebrate 🎉 with how your body felt after. Naming the shift out loud makes it land deeper.",
    ],
  },
  ...
  // ============== DAY 5 ==============
  {
    ...
    concepts: [
      ...
      { type: "accordion", headline: "Claiming it out loud is part of the work", icon: "🙏",
        body: "Posting your win in the feed is not just social. Saying it out loud, having the audacity to claim it where people can see, that is how you normalize it in your body. Drop your win and your 444 in Let's Celebrate. The more you treat your desire like it is already real, the faster it arrives." },
    ...
    actions: [
      ...
      "Post your first win or first shift in Let's Celebrate 🎉 and drop 444 to lock it in.",
  ...
  // ============== DAY 6 ==============
  {
    ...
    actions: [
      ...
      "Come post in Let's Celebrate when someone joins through your link so we can celebrate you.",
    ],
        ...
        <div className="main" key={`${active}-${reveal}`}>
          <div className="main-inner">
            ...
            <div className="tab-content" key={active}>
              ...
              {lesson.prompt && (
                <div className="pane">
                  <div className="page-label">Your Claude prompt</div>
    ...
    <div className="sttp-wrap reveal" style={{ animationDelay: "300ms" }}>
      ...
      <div className="sttp-diagram">
        <svg viewBox="0 0 500 180" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* center tool */}
          <rect x="200" y="70" width="100" height="40" rx="10" fill="#faf7f1" stroke="url(#sttpLine)" strokeWidth="2" />
...
.mock-saved-check{
  ...
  background:var(--mint);color:#faf7f1;
  display:flex;align-items:center;justify-content:center;
...
.pullquote{
  ...
  background:linear-gradient(135deg, #fdfbf6, #faf6ec, #fdfbf6);
  border-radius:18px;
...
.mission-card{
  position:relative;
  background:linear-gradient(135deg, #ffffff 0%, #fbf8f2 60%, #ffffff 100%);
  border:1px solid var(--border-strong);
  border-radius:24px;
